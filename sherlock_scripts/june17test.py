...
def sbatch(job_name, command, logfile=logfile, time=1, mem=1, dep=''):
    if dep != '':
    ...
    sbatch_command = "sbatch -J {} -o {}.out -e {}.err -t {}:00:00 --partition=trc --open-mode=append --cpus-per-task={} --wrap='{}' {}".format(job_name, logfile, logfile, time, mem, command, dep)
