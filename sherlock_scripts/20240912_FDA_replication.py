...
def main():
	...
	main_dir = "/oak/stanford/groups/trc/data/Brezovec/20240912_FDA_replication"
	...
	resolution = (.6,.6,1)#(0.49,0.49,2)#(0.49,0.49,1)##(.76,.76,1)#(2, 2, 2)#(.65,.65,1)#
	...
	name_out = 'affine_0'
	name_fixed = "seed_fly91_clean_20200803.nii"
