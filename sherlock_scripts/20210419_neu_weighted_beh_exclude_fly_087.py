...
def main(args):
	...
	fly_names = ['fly_089', 'fly_094', 'fly_097', 'fly_098', 'fly_099', 'fly_100', 'fly_101', 'fly_105']
	...
	for z in range(9,49-9):
		...
		for cluster_num in range(n_clusters):
		    ...
		    X_cluster = np.reshape(np.moveaxis(Xs_new,0,1),(-1,27072))
		...
		### Save Responses ###
		######################
		save_file = F"/oak/stanford/groups/trc/data/Brezovec/2P_Imaging/20210419_neural_weighted_behavior_exclude_fly_087/responses_{z}"
