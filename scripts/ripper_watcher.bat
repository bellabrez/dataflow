...
"C:\Users\User\AppData\Local\Programs\Python\Python37\python.exe" "C:\Users\User\projects\dataflow\dataflow\check_for_raw.py"
set /p RIPPER_DONE=<"batch_communicate\ripper_done.txt"
