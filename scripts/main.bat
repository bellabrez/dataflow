...
"C:\Users\User\AppData\Local\Programs\Python\Python37\python.exe" "C:\Users\User\projects\dataflow\scripts\check_for_bruker_transfer.py"
echo Done checking for files to transfer.

:: check if files were transfered by python ftp
set /p FOUND_FILES=<found_files.txt
